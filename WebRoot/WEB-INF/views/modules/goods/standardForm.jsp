...
<body>
	...
	<form:form id="inputForm"  modelAttribute="standard" action="${ctx}/standard/saveStandard" method="post" class="form-horizontal">
		<form:hidden path="gId"/>
		<tags:message content="${message}"/>
		
		<div class="control-group">
			<label class="control-label" for="standard">规格编号:</label>
			<div class="controls">
				${standard.sId}
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="file" name="greatImg"  />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="middleImg">中图:</label>
			<div class="controls">
				<input type="file" name="middleImg" />
			</div>
		</div>
		<div class="control-group">
