...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo.png" alt="LOGO" style="height:40px;"></a>
        </div>
      </div>
    </div>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2015-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://www.nbse.net.cn" target="_blank">量子科技</a> ${fns:getConfig('version')}
    </footer>
  </body>
</html>