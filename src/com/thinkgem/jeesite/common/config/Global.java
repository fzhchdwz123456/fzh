...
public class Global {
	...
	public static String getUploadFileDir(){
		String dir = getConfig("uploadfile.dir");
		Assert.hasText(dir, "配置文件里没有配置uploadfile.dir属性");
		if(!dir.endsWith("/")) {
			dir += "/";
		}
		return dir;
	...
	public static String getExportFileDir(){
		String dir = getConfig("exportfile.dir");
		Assert.hasText(dir, "配置文件里没有配置exportfile.dir属性");
		if(!dir.endsWith("/")) {
			dir += "/";
		}
		return dir;
